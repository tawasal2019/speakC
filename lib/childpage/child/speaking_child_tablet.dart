...
class _SpeakingChildTabletState extends State<SpeakingChildTablet> {
                                                                        ...
                                                                        if (v
                                                                          ...
                                                                          autoComplete(
                                                                            ...
                                                                            fieldContent
                                                                                .isNotEmpty) {
                                                                          predict(
                                                                              fieldContent[fieldContent.length - 1].nameContent);
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        for (var element
                                                                          ...
                                                                          main.add([
                                                                            element.nameContent,
                                                                            element.imageURL,
                                                                            //انا اضفتها ماادري استفيد منها او لا
                                                                            element.localVoiceFilePath,
                                                                          ]);
                                                                        }
                                                                        setState(
                                                                            () {
                                                                        ...
                                                                        if (fieldContent
                                                                          ...
                                                                          if (!fav
                                                                            ...
                                                                            for (int y = 0;
                                                                                ...
                                                                                y++) {
                                                                              String input = fieldContent[y].nameContent;
                                                                              String imurl = fieldContent[y].imageURL;
                                                                              String isimup = fieldContent[y].isImageUploadbyUser.toString();
                                                                              String voiceurl = fieldContent[y].localVoiceFilePath;
                                                                              String voiceCache = fieldContent[y].firebaseVoiceFilePath;
                                                                              String isvoiceUp = fieldContent[y].isVoiceUploadByUser.toString();
                                                    ...
                                                    children: [
                                                      Expanded(
                                                        child: InkWell(
                                                          ...
                                                          onTap: () {
                                                            // print("اتوقع هالمره اني وصلت اخيرا الحمدلله");
                                                            bool t = Provider.of<
                                                                        MyProvider>(
                                                                    context,
                                                                    listen:
  ...
  oneWordChild(int counter) async {
    ...
    for (int i = 0; i < wordsP.length; i++) {
      if (predictionWords.length < 16 && !searchInPredictionWords(wordsP[i])) {
