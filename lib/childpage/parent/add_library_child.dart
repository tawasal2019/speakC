...
class _AddChildLibraryState extends State<AddChildLibrary> {
  ...
  bool errorsen = false;
  bool isCameraPermissioned = false;
  bool isGallaryPermissioned = false;
              ...
              CupertinoDialogAction(
                child: const Text(" الاستديو",
                    style: TextStyle(
                        ...
                        fontWeight: FontWeight.bold)),
                onPressed: () {
                  /* checkGallaryPermissionStatus().then((result){
                    isGallaryPermissioned=result;
                    print("result after called checkMGallaryPermissionStatus is $result");
