...
List<lib> constantLib = [
  lib("المستشفى", "assets/7ss.png", "yes", [
    Content("عندي ألم في بطني", "assets/images/stomach-ache.png", "false", "",
        "", "false"),
    Content("عندي ألم في رجلي", "assets/images/legPain.png", "false", "", "",
        "false"),
    Content("عندي ألم في يدي", "assets/images/injury.png", "false", "", "",
        "false"),
    Content("عندي ألم في رأسي", "assets/images/headache.png", "false", "", "",
        "false"),
    Content(
        "إرفع يدي", "assets/images/raiseHand.png", "false", "", "", "false"),
    Content("إرفع رجلي", "assets/images/fitness.png", "false", "", "", "false"),
    Content(
        "حرك الوسادة فوق", "assets/images/move5.png", "false", "", "", "false"),
    Content("حرك الوسادة تحت", "assets/images/move-2.png", "false", "", "",
        "false"),
    Content("حرك الوسادة يمين", "assets/images/move-3.png", "false", "", "",
        "false"),
    Content("حرك الوسادة يسار", "assets/images/move-4.png", "false", "", "",
        "false"),
    Content("إقلبني على جنب الأيمن", "assets/images/driving.png", "false", "",
        "", "false"),
    Content("إقلبني على جنب الأيسر", "assets/images/driving-2.png", "false", "",
        "", "false"),
    Content("اغلق الباب", "assets/images/door.png", "false", "", "", "false"),
    Content("اغلق النور", "assets/images/bulb.png", "false", "", "", "false"),
    Content("احتاج مساعدة", "assets/images/help.png", "false", "", "", "false"),
    Content("احتاج شفط", "assets/images/suction.png", "false", "", "", "false"),
    Content("أريد الاتصال", "assets/images/phonecall.png", "false", "", "",
        "false"),
    /* Content("أريد أن احجز موعد قريبا ", "assets/appointment.png", "false", "", "",
        "false"),
    Content(
        "لدي الم شديد هنا ", "assets/muscle-pain.png", "false", "", "", "false"),
    Content("أريد الإسعاف عاجلا ",
        "assets/IconLib/transportation/ambulance.png", "false", "", "", "false"),
    Content("هل يوجد مستوصف قريب من هنا", "assets/clinic.png", "false", "", "",
        "false"),
    Content("أريد صرف الدواء من فضلك ", "assets/medicine.png", "false", "", "",
        "false"),
    Content("كم جرعة الدواء ومتى؟", "assets/clock.png", "false", "", "", "false"),
    Content("شكرا لك و أنا ممنون لك", "assets/positive-vote.png", "false", "", "",
        "false"),
    Content("اطلب الطبيب لي", "assets/doctor.png", "false", "", "", "false")*/
  ]),
  lib("التحيات", "assets/1ss.png", "yes", [
    Content("كيف حالك؟ ", "assets/question.png", "false", "", "", "false"),
    Content("اهلا وسهلا ", "assets/waving-hand.png", "false", "", "", "false"),
    Content("مرحبا حياك الله ", "assets/introduction.png", "false", "", "",
        "false"),
    Content(
        "أنا بخير والحمدلله ", "assets/prayer.png", "false", "", "", "false"),
    Content("وعليكم السلام ", "assets/hello.png", "false", "", "", "false"),
    Content("سعدت بالحديث معك مع السلامة ", "assets/hello (1).png", "false", "",
        "", "false")
  ]),
  lib("العمل", "assets/2ss.png", "yes", [
    Content(
        "أين مكتب العمل؟ ", "assets/location.png", "false", "", "", "false"),
    Content(
        "أريد السكرتير ", "assets/secretary (1).png", "false", "", "", "false"),
    Content("أنا ابحث عن عمل يناسبني ", "assets/wheelchair (1).png", "false",
        "", "", "false"),
    Content(
        "هل انتهى الدوام ؟ ", "assets/expired.png", "false", "", "", "false"),
    Content("ماهي البيانات المطلوبة", "assets/requirement.png", "false", "", "",
        "false"),
    Content(
        "كيف أخدمك ؟ ", "assets/manufacturing.png", "false", "", "", "false")
  ]),
  lib("السوق", "assets/3ss.png", "yes", [
    Content("كم سعر هذا؟", "assets/how-much.png", "false", "", "", "false"),
    Content("السعر مرتفع جدًا", "assets/money.png", "false", "", "", "false"),
    Content("هل لديكم فرع آخر؟", "assets/branch.png", "false", "", "", "false"),
    Content(
        "أريد خضراوات طازجة", "assets/vegetable.png", "false", "", "", "false"),
    Content("هل لديكم تخفيضات؟", "assets/tag.png", "false", "", "", "false"),
    Content("أين أجد قسم الملابس؟", "assets/clothing.png", "false", "", "",
        "false"),
    Content("أريد أن تساعدني في الحصول على القطع في الرف المرتفع",
        "assets/stand.png", "false", "", "", "false"),
    Content("لقد سقط هذا مني أرجوك أحضره", "assets/bring-to-front.png", "false",
        "", "", "false"),
    Content("أريد أن أدفع المبلغ تفضل", "assets/money (1).png", "false", "", "",
        "false"),
    Content("أريد إرجاع هذا لأنه لا يناسبني", "assets/exchange.png", "false",
        "", "", "false")
  ]),
  lib("السفر", "assets/4ss.png", "yes", [
    Content("الأجواء معتدلة وممتعة هنا", "assets/happiness.png", "false", "",
        "", "false"),
    Content("أريد أن أحجز تذكرة", "assets/plane-ticket.png", "false", "", "",
        "false"),
    Content("أريد أن أسجل الحضور", "assets/note.png", "false", "", "", "false"),
    Content("أريد الحصول على تخفيض ذوي الاعاقة", "assets/flight.png", "false",
        "", "", "false"),
    Content("كم تكلفة السفر", "assets/budget.png", "false", "", "", "false"),
    Content("أبحث عن مساعد ليساعدني في اتمام سفري",
        "assets/customer-service.png", "false", "", "", "false"),
    Content(
        "هل بوابة الرحلة مفتوحة؟", "assets/gate.png", "false", "", "", "false"),
    Content("هذه أمتعتي أريدك أن تساعدني", "assets/travel-bag.png", "false", "",
        "", "false"),
    Content("شكرًا لك وأنا ممنون لك", "assets/IconLib/body/hands.png", "false",
        "", "", "false")
  ]),
  lib("المدرسة", "assets/5ss.png", "yes", [
    Content("أستاذ أنا لم أفهم هذه المسألة", "assets/hypothesis.png", "false",
        "", "", "false"),
    Content("أريد أن أحل هذه المسألة", "assets/problem (1).png", "false", "",
        "", "false"),
    Content("لقد انتهيت", "assets/tick.png", "false", "", "", "false"),
    Content("أريد الخروج من الفصل", "assets/exit-door.png", "false", "", "",
        "false"),
    Content(
        "كم درجة الاختبار؟", "assets/homework.png", "false", "", "", "false"),
    Content("متى ينتهي الدوام؟", "assets/working-time.png", "false", "", "",
        "false"),
    Content("أريد أن تساعدني في كتابة عبارات جديدة لاستخدامها في المدرسة",
        "assets/skill.png", "false", "", "", "false"),
    Content("إلى اللقاء، مع السلامة", "assets/goodbye.png", "false", "", "",
        "false"),
    Content("مسطرة", "assets/ruler.png", "false", "", "", "false"),
    Content("دباسة", "assets/stapler.png", "false", "", "", "false"),
    Content("ملصقات", "assets/stickers.png", "false", "", "", "false"),
    Content("مقص", "assets/sicssor.png", "false", "", "", "false"),
    Content("قلم رصاص", "assets/pencil.png", "false", "", "", "false"),
    Content("مقلمة", "assets/pincelCase.png", "false", "", "", "false"),
    Content("كرسي", "assets/seat.png", "false", "", "", "false"),
    Content("قلم", "assets/pen.png", "false", "", "", "false"),
    Content("معجم", "assets/dic.jpg", "false", "", "", "false"),
    Content("كتاب", "assets/book.png", "false", "", "", "false"),
    Content("ورق", "assets/paper.png", "false", "", "", "false"),
    Content("ممحاة", "assets/eraser.png", "false", "", "", "false"),
  ...
  lib("المطعم", "assets/6ss.png", "yes", [
    Content(
        "كم سعر هذه الوجبة؟", "assets/inflation.png", "false", "", "", "false"),
    Content("هل لديكم توصيل للمنازل؟", "assets/home-delivery.png", "false", "",
        "", "false"),
    Content("أنا أستخدم برنامج على الهاتف للتواصل معك، فأرجو أن تتساعد معي",
        "assets/smartphone.png", "false", "", "", "false"),
    Content("الطعم لذيذ شكرًا", "assets/tasty.png", "false", "", "", "false"),
    Content("هل لديكم شبكة للدفع؟", "assets/mobile-payment.png", "false", "",
        "", "false"),
    Content("كم مجموع الطعام؟", "assets/hand.png", "false", "", "", "false"),
    Content("أريد الباقي لوسمحت", "assets/payment-method.png", "false", "", "",
        "false"),
    Content("أبحث عن مطعم شعبي قريب من هنا", "assets/restaurant (1).png",
        "false", "", "", "false"),
    Content("من فضلك إقرأ قائمة الطعام لي", "assets/menu.png", "false", "", "",
        "false")
  ]),
  lib("المسجد", "assets/8ss.png", "yes", [
    Content("هل قامت الصلاة", "assets/shalat.png", "false", "", "", "false"),
    Content("أريد ان اتوضأ أين المواضئ ", "assets/wudhu.png", "false", "", "",
        "false"),
    Content("كم ركعة فاتتني ", "assets/islamic.png", "false", "", "", "false"),
    Content("أين اتجاه القبلة", "assets/kaaba.png", "false", "", "", "false"),
    Content(
        "أين يقع اقرب مسجد", "assets/ramadan.png", "false", "", "", "false"),
    Content("هل يوجد مدخل خاص للكراسي المتحركة ؟ ", "assets/ramp.png", "false",
        "", "", "false")
  ]),
