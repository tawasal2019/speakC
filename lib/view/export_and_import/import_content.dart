import '../../childpage/child/speaking_child_tablet.dart';
                ...
                return InkWell(
                  onTap: () async {
                    if (!cantPressed) {
                      ...
                      String path = widget.content[index].firebaseVoiceFilePath;
                      if (path.isNotEmpty) {
                        ...
                        howToSpeak(widget.content[index].nameContent, context);
                  ...
                  child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(children: [
                          ...
                          Expanded(
                              child: getImage(widget.content[index].imageURL)),
                          Container(
                            height: 4,
                          ),
                          Text(
                            noMoreText(widget.content[index].nameContent),
